...
export const ALL_PUBMON: PubMon[] = [
  ...
  {
    id: 3, name: "Stoutaur", type: "beer", hp: 55, maxHp: 55, level: 5, xp: 0,
    attack: 16, defense: 15,
    moves: ["Dark Roast", "Horn Charge", "Barley Stomp", "Thick Foam"],
    sprite: "stoutaur",
    description: "A hulking beast made of dark, heavy earth. It hits with the force of a falling keg.",
    visuals: "a fakemon, a hulking, centaur-like beast constructed from dark, compacted earth and heavy roasted malt. A thick, creamy tan foam sits across its broad shoulders like a mantle. Deep, light-absorbing browns and blacks emphasize its massive, immovable weight.",
    cry: 142
  },
  {
    id: 4, name: "Pilsenor", type: "beer", hp: 45, maxHp: 45, level: 5, xp: 0,
    attack: 12, defense: 12,
    moves: ["Crisp Strike", "Pale Glow", "Malt Shield", "Glass Shatter"],
    sprite: "pilsenor",
    description: "A bright and snappy PubMon. Its crystalline armor is fragile but dangerously sharp.",
    visuals: "a fakemon, a sharp, avian biped encased in fragile, crystalline glass armor over a bright yellow, fluid core. The translucent shell features harsh, angular specular highlights that imply dangerously sharp edges, contrasting with the warm, snappy golden liquid inside.",
    cry: 15
  },
  {
    id: 5, name: "Ipape", type: "beer", hp: 48, maxHp: 48, level: 5, xp: 0,
    attack: 15, defense: 9,
  ...
  {
    id: 6, name: "Cidra", type: "beer", hp: 42, maxHp: 42, level: 5, xp: 0,
    attack: 14, defense: 10,
    moves: ["Apple Bite", "Ferment Breath", "Orchard Strike", "Sweet Spray"],
    sprite: "cidra",
    description: "Often found near fallen orchards, this multi-headed serpent ferments apples in its belly.",
    cry: 101,
    visuals: "a fakemon, a multi-headed serpentine hydra with scales resembling the mottled skin of fermented apples. Its bulbous bellies suggest heavy, fluid-filled internal fermentation. Rich autumnal reds and golds gleam with a sticky, sweet-and-sour wetness.",
  },
  {
    id: 7, name: "Alehorn", type: "beer", hp: 49, maxHp: 49, level: 5, xp: 0,
  ...
  {
    id: 8, name: "Caskarok", type: "beer", hp: 60, maxHp: 60, level: 5, xp: 0,
  ...
  {
    id: 9, name: "Jubelite", type: "beer", hp: 44, maxHp: 44, level: 5, xp: 0,
    attack: 13, defense: 11,
    moves: ["Peach Fuzz", "Amber Drop", "Lager Lunge", "Sweet Sap"],
    sprite: "jubelite",
    description: "A sweet, earth-dwelling creature infused with peach nectar. Its fuzzy exterior softens physical blows.",
    cry: 39,
  ...
  // ==========================================
  {
    id: 10, name: "Absintile", type: "shot", hp: 38, maxHp: 38, level: 5, xp: 0,
    attack: 16, defense: 7,
  ...
  },
  {
    ...
    sprite: "whisker",
    description: "A feline spirit aged in oak. It leaves behind a trail of warm, smoky embers.",
    cry: 52,
    visuals: "a fakemon, a lithe feline spirit composed of warm, glowing embers and aged oak bark. As it moves, its tail trails thick, volumetric peat smoke. Deep coppers and fiery oranges glow softly from within its wooden, barrel-aged exterior."
  },
  {
    id: 14, name: "Jagerstag", type: "shot", hp: 45, maxHp: 45, level: 5, xp: 0,
    attack: 14, defense: 11,
    moves: ["Antler Smash", "Herbal Brew", "Licorice Bite", "Forest Spirit"],
    sprite: "jagerstag",
    description: "A proud deer that roams the black forests. It draws power from 56 secret botanicals.",
    cry: 135,
    visuals: "a fakemon, a proud, spectral stag roaming on legs of dark, herbaceous shadow. Its massive antlers glow with a dark, licorice-colored fire. Intricate, botanical textures are etched into its dark, matte coat, implying ancient, secret forest magic."
  },
  {
    id: 15, name: "Gingeist", type: "shot", hp: 36, maxHp: 36, level: 5, xp: 0,
    attack: 16, defense: 7,
    moves: ["Juniper Phantom", "Botanical Hex", "Clear Strike", "Tonic Illusion"],
    sprite: "gingeist",
  ...
  },
  {
    ...
    sprite: "samburst",
    description: "It carries three lucky coffee beans on its head. Ignites itself for massive, reckless damage.",
    cry: 63,
    visuals: "a fakemon, a tiny, hyperactive imp whose head is crowned with three distinct, coffee-bean-shaped nodes. The body is engulfed in reckless, sticky blue-and-purple flames. Bright, aggressive specular highlights imply a dangerous, syrupy, highly flammable volume."
  },
  {
    id: 17, name: "Cinnaburn", type: "shot", hp: 37, maxHp: 37, level: 5, xp: 0,
    attack: 17, defense: 6,
  ...
  {
    id: 23, name: "Pinota", type: "wine", hp: 46, maxHp: 46, level: 5, xp: 0,
    attack: 14, defense: 11,
    moves: ["Earthy Aroma", "Velvet Claw", "Cherry Strike", "Noir Veil"],
    sprite: "pinota",
    description: "A highly sensitive, brooding fairy-type that requires a very specific climate to thrive.",
    cry: 122,
    visuals: "a fakemon, a brooding, delicate fairy with thin, frail limbs and a cloak of deep, bruised-purple grape leaves. Its highly sensitive anatomy features sharp, angular shadows and a muted, earthy palette that conveys a moody, complex materiality."
  },
  {
    id: 24, name: "Blancbat", type: "wine", hp: 38, maxHp: 38, level: 5, xp: 0,
    attack: 15, defense: 9,
  ...
  {
    id: 25, name: "Champain", type: "wine", hp: 42, maxHp: 42, level: 5, xp: 0,
    attack: 13, defense: 10,
    moves: ["Celebration Pop", "Vintage Blast", "Bubbly Shield", "Prestige Strike"],
    sprite: "champain",
    description: "Only true Champain hail from a specific region; all others are merely sparkling mimics.",
    cry: 149,
    visuals: "a fakemon, an elite, regal fairy adorned in prestige armor that mimics polished, pale-gold glass and popping corks. Radiant, celebratory lighting catches the high-gloss, bubbly shield around its body, projecting an aura of explosive, expensive energy."
  },
  {
    id: 26, name: "Sauviflora", type: "wine", hp: 41, maxHp: 41, level: 5, xp: 0,
    attack: 12, defense: 10,
  ...
  {
    id: 27, name: "Buckfiend", type: "wine", hp: 44, maxHp: 44, level: 5, xp: 0,
    attack: 16, defense: 7,
  ...
  {
    id: 28, name: "Magnumoth", type: "wine", hp: 55, maxHp: 55, level: 5, xp: 0,
    attack: 14, defense: 15,
    moves: ["Iron Wing", "Vigorous Buzz", "Roots Smash", "Tonic Dance"],
    sprite: "magnumoth",
    description: "A vigorous, iron-forged fairy-type fueled by Jamaican roots and vitamins. It dances relentlessly.",
    cry: 131,
  ...
  // ==========================================
  {
    id: 29, name: "Springer", type: "water", hp: 50, maxHp: 50, level: 5, xp: 0,
    ...
    cry: 11,
    visuals: "a fakemon, a pure, quadrupedal water spirit whose anatomy is made entirely of crystal-clear, flowing spring water. Complete translucency and high-refraction specular highlights emphasize a flawless, clean, and constantly undulating liquid volume."
  },
  {
  ...
  {
    id: 31, name: "Sparklid", type: "water", hp: 42, maxHp: 42, level: 5, xp: 0,
  ...
  {
    id: 32, name: "Tonica", type: "water", hp: 44, maxHp: 44, level: 5, xp: 0,
    attack: 11, defense: 12,
  ...
  {
    id: 33, name: "Seltzerpent", type: "water", hp: 45, maxHp: 45, level: 5, xp: 0,
    attack: 14, defense: 9,
  ...
  {
    id: 34, name: "Cuberg", type: "water", hp: 55, maxHp: 55, level: 5, xp: 0,
    attack: 9, defense: 18,
  ...
  {
    id: 35, name: "H2Owl", type: "water", hp: 40, maxHp: 40, level: 5, xp: 0,
    attack: 15, defense: 8,
    moves: ["Hydration Swoop", "Pure Wing", "Night Droplet", "Dew Feather"],
    sprite: "h2owl",
    description: "A wise, fluid avian that keeps the pub ecosystem hydrated and functioning smoothly.",
    cry: 85,
    visuals: "a fakemon, a wise, fluid avian whose feathers are perfectly formed, heavy droplets of pure morning dew. Its large, dark eyes contrast with the translucent, watery plumage, creating a soft, deeply hydrated, and smoothly flowing aerial silhouette."
  },
  {
    id: 36, name: "Cucumbrax", type: "water", hp: 47, maxHp: 47, level: 5, xp: 0,
  ...
  {
    id: 38, name: "Aperol", type: "cocktail", hp: 43, maxHp: 43, level: 5, xp: 0,
    attack: 13, defense: 11,
  ...
  {
    id: 39, name: "Caiprinha", type: "cocktail", hp: 41, maxHp: 41, level: 5, xp: 0,
    attack: 15, defense: 9,
    ...
    cry: 83,
    visuals: "a fakemon, a stout, tropical warrior encased in thick, heavily muddled lime-green rind armor. Its coarse, sugary exterior features granular, crystalline highlights that contrast with the raw, wet, bruised plant matter of its powerful, bipedal form."
  },
  {
    id: 40, name: "Mojitoad", type: "cocktail", hp: 48, maxHp: 48, level: 5, xp: 0,
  ...
  {
    id: 41, name: "Coladactyl", type: "cocktail", hp: 40, maxHp: 40, level: 5, xp: 0,
    attack: 16, defense: 9,
  ...
  {
    id: 42, name: "Maryvine", type: "cocktail", hp: 50, maxHp: 50, level: 5, xp: 0,
    attack: 11, defense: 13,
    moves: ["Tomato Tang", "Celery Whip", "Tabasco Burn", "Hangover Cure"],
    sprite: "maryvine",
    description: "A restorative but deeply savory plant. Its celery stalks act as protective spears.",
    cry: 72,
    visuals: "a fakemon, a deeply savory, rooted plant creature anchored by a thick, pulpy, blood-red tomato core. Tall, rigid celery stalks act as protective spears. Deep, rich reds and intense, peppery textures imply a thick, restorative, and highly caustic biological soup."
  },
  {
    id: 43, name: "Oldfash", type: "cocktail", hp: 46, maxHp: 46, level: 5, xp: 0,
    attack: 15, defense: 11,
    moves: ["Bitters Strike", "Orange Peel Lash", "Bourbon Bash", "Muddled Stomp"],
    sprite: "oldfash",
    description: "A traditionalist PubMon that refuses to evolve. It relies on tried-and-true physical strikes.",
    cry: 108,
