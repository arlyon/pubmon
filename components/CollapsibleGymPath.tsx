...
export function CollapsibleGymPath({ currentGymId, badges = new Set(), onSelectGym }: CollapsibleGymPathProps) {
          ...
          <div className="flex items-center gap-3">
            ...
            <div
              ...
              style={{
                ...
                background: badges.has(currentGymId) ? `${currentGym.badgeColor}22` : "transparent",
              }}
            >
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-[10px] text-foreground mt-1">{currentGym.name}</p>
              <p className="text-[8px] text-muted-foreground">{currentGym.subtitle}</p>
            </div>
