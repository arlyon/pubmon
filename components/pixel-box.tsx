...
export function PixelBox({ children, className = "", variant = "default", style }: PixelBoxProps) {
  ...
  return (
    <div
      className={`
        relative border-4 ${borderColors[variant]} ${bgColors[variant]}
...
export function PixelButton({
  ...
  const variants = {
    default: "bg-secondary text-secondary-foreground border-foreground hover:bg-accent",
    primary: "bg-primary text-primary-foreground border-foreground hover:brightness-110",
    danger: "bg-destructive text-destructive-foreground border-foreground hover:brightness-110",
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={`
        border-4 px-4 py-2 font-sans text-[10px]
