...
import type { TournamentBracket, TournamentMatch } from "@/src/types/game-state";
  ...
  return (
    <div className="max-w-md mx-auto flex flex-col gap-4 p-4">
      <div className="text-center">
        ...
        <p className="text-[8px] text-muted-foreground">Round {bracket.round}</p>
      </div>
        ...
        <PixelBox variant="battle" className="w-full">
          <div className="p-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                <p className="text-[9px] font-bold">
                  {myMatch.player2SessionId === sessionId ? "YOU" : myMatch.player2SessionId ? "Opponent" : "BYE"}
                </p>
            ...
            <div className="mt-3 text-center">
              <p className={`text-[10px] font-bold ${getMatchStatus(myMatch).color}`}>
